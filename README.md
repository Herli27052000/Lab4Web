...
<body>
    <div id="container">
        ...
        <section id="about">
            <div class="row">
                <img src="herli.JPG" title="Herliyansyah" alt="Herliyansyah" width="200px
                " class="image-circle" style="float: left; border: 2px solid black;">
                <h1>Herliyansyah</h1>
                <p>Nama saya Herliyansyah, Saya adalah seorang mahasiswa Universitas Pelita Bangsa,Jurusan Teknik Informatika. Saya lahir di Bekasi,27 Mei 2000. dan saya juga sedang mempelajari html css js dan php sebagai jalan menuju front end developer</p>
            </div>
        </section>
        <footer>
            <p style="text-align: center;">@HERLIYANSYAH</p>
        </footer>
    </div>
</body>
</html>
...
## Untuk Pertemuan Kali ini cukup sampai disini dan sampai bertemu dipertemuan berikut nya.
